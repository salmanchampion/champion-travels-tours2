...
export const siteConfig: Pick<AppData, 'site' | 'header' | 'floatingButton' | 'prayerTimes' | 'footer' | 'theme' | 'globalConfig'> = {
    site: {
    ...
    globalConfig: {
        ...
        siteIdentity: {
            siteName: 'Champion Travels & Tours',
        ...
        marketingPopup: {
            ...
            content: 'Sign up for our newsletter and get exclusive updates on Hajj 2026 packages.',
