...
const WhyChooseUs: React.FC = () => {
  ...
  return (
    <div className="bg-[var(--color-dark-bg)]" style={{ backgroundImage: `url('${whyChooseUs.backgroundImage}')` }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 text-[var(--color-light-text)]">

        {/* Section 1: Expert Umrah Guides */}
        <section className="flex flex-col lg:flex-row items-center gap-10 lg:gap-12 mb-16 md:mb-24">
          <div className="lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
            <span className="text-[var(--color-primary)] font-bold uppercase tracking-wider text-sm md:text-base">{whyChooseUs.guides.tagline}</span>
            <h2 className="text-3xl md:text-5xl font-display font-bold text-[var(--color-light-text)] mt-2 mb-4 leading-tight">{whyChooseUs.guides.title}</h2>
            <p className="text-base md:text-lg text-[var(--color-muted-text)] mb-4 leading-relaxed">
              {whyChooseUs.guides.description}
            </p>
            <h3 className="text-xl md:text-2xl font-bold text-[var(--color-light-text)] mb-6">{whyChooseUs.guides.subheading}</h3>
            <p className="text-sm md:text-base text-[var(--color-muted-text)] mb-8">
              {whyChooseUs.guides.subDescription}
            </p>
            <CtaButton href="#packages">{whyChooseUs.guides.buttonText}</CtaButton>
          </div>
          <div className="lg:w-1/2 w-full flex justify-center items-center order-1 lg:order-2 mb-8 lg:mb-0">
            <div className="relative w-full h-64 sm:h-80 md:h-96 max-w-lg">
              <img 
              ...
              />
              <div className="absolute -bottom-4 -left-4 w-24 h-24 md:w-32 md:h-32 bg-[var(--color-secondary)]/20 rounded-full -z-10"></div>
              <div className="absolute -top-4 -right-4 w-16 h-16 md:w-24 md:h-24 bg-[var(--color-primary)]/20 rounded-lg transform rotate-12 -z-10"></div>
            </div>
          </div>
        </section>

        {/* Section 2: Board of Director */}
        <section className="flex flex-col md:flex-row-reverse items-center gap-10 md:gap-12 mb-16 md:mb-24 relative">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-[var(--color-light-text)] mb-4 leading-tight">{whyChooseUs.directors.title}</h2>
            <p className="text-base md:text-lg text-[var(--color-muted-text)] mb-6 leading-relaxed"
        ...
        <section className="flex flex-col md:flex-row items-center gap-10 md:gap-12 mb-16 md:mb-24">
          <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-[var(--color-light-text)] mb-6 leading-tight">{whyChooseUs.services.title}</h2>
            <ul className="space-y-4 mb-8 text-base md:text-lg inline-block text-left">
          ...
          <div className="md:w-1/2 flex justify-center mt-8 md:mt-0">
            <img src={whyChooseUs.services.image} alt="Services Offered" className="max-w-xs md:max-w-md w-full" />
          </div>
        </section>
        ...
        <section className="text-center py-12 md:py-16">
            <div className="flex justify-center mb-8">
                <img 
                    ...
                    className="rounded-[var(--ui-border-radius)] shadow-lg w-full max-w-lg object-cover aspect-video"
                />
            </div>
            <h2 className="text-2xl md:text-4xl font-display font-bold text-[var(--color-light-text)] max-w-3xl mx-auto leading-tight">
      ...
      <footer className="h-24 md:h-40 bg-center bg-repeat-x bg-contain md:bg-auto" style={{ backgroundImage: `url('${whyChooseUs.footerImage}')` }}>
      </footer>
    </div>
  );
};
