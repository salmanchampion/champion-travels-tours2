...
const MobileBottomNav: React.FC = () => {
    const { appData, setPrayerTimesOpen, isPrayerTimesOpen } = useContext(DataContext);
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 bg-[#0B0F19]/95 backdrop-blur-lg border-t border-gray-800 z-[90] pb-safe">
            <div className="flex justify-around items-center h-16 px-2">
                ...
                {/* Admin */}
                <a href="#admin" className="flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-[var(--color-secondary)] transition-colors">
                    <svg className="w-6 h-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
