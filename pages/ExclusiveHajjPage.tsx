...
const ExclusiveHajjPage: React.FC = () => {
    const { appData } = useContext(DataContext);
    const { pageData, packages } = appData.exclusiveHajj;
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-full font-bold transition-all duration-300 border-2 ${
                                    activeTab === cat 
                                        ...
                                        : 'bg-transparent border-gray-600 text-[var(--color-muted-text)] hover:border-[var(--color-primary)] hover:text-white'
                                }`}
                            >
                                {cat}
                            </button>
...
export default ExclusiveHajjPage;
